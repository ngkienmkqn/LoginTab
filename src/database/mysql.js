...
// Config is AES-256 encrypted to protect credentials in source code
// Key is obfuscated to prevent casual exposure

// Encrypted database configuration (generated by ConfigCrypto.js)
const ENCRYPTED_DB_CONFIG = '';
...
function getDecryptionKey() {
    // Key: "LoginTabSecure2026" split into obfuscated parts
    const parts = [
        Buffer.from('TG9naW4=', 'base64').toString(),  // "Login"
        'Tab',                                           // "Tab"
        String.fromCharCode(83, 101, 99, 117, 114, 101), // "Secure"
        '2026'                                           // "2026"
    ];
    return parts.join('');
}
...
/**
 * Decrypt database configuration at runtime
 */
function getDbConfig() {
    try {
        const key = getDecryptionKey();
        const bytes = CryptoJS.AES.decrypt(ENCRYPTED_DB_CONFIG, key);
        ...
        console.error('[MySQL] Failed to decrypt database configuration:', error.message);
        throw new Error('Database configuration error - please check encryption key');
    }
}

// Get decrypted config at module load time
